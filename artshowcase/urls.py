...
urlpatterns = [
    ...
    path('camilias_art1/',views.Camilia_art1,name='Camilia_art1'),
    path('camilias_art2/',views.Camilia_art2,name='Camilia_art2'),
    path('camilias_art3/',views.Camilia_art3,name='Camilia_art3'),
